...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // 1. LEER TECLADO (PC / Editor / Teclado OTG)
        ...
        // 2. LEER MOUSE (Para pruebas rápidas haciendo clic en el Editor)
#if UNITY_EDITOR
        ...
        // 3. LEER PANTALLA TÁCTIL (Zonas completas Izq/Der para Android)
